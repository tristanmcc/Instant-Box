    ...
    <div className="site">
      ...
      <div className="homePage">
        ...
        <div className="content">
          <p>
            Instant box is a shipping service available in selected online
            stores. We ship your package to one of our hundreds of smart
            cabinets, usually the same day you place the order.
          </p>
        </div>
        ...
        <ul className="content">
          ...
          <li>
            3. You pick up your package with the PIN code, without having to
            stand in line at the postal agent for a single second.
          </li>
        </ul>
      </div>
      <Footer />
